...
const AdminNotification = () => {
  ...
  const fetchMessages = async () => {
    try {
      ...
      // Filter out dismissed messages and messages sent by the admin
  ...
  return (
    <div className="p-8 mb-8">
      ...
      <div className="font-bold text-xl mt-48 ml-32 z-50 top-[500px]"></div>
        ...
        <ul className="space-y-4">
          {messages.map((msg) => (
            ...
            >
              ...
              <small className="text-gray-500 mt-9 display flex text-end">
